...
void MySQLTest::main()
{
	...
	try
	{
		test.testBareboneMySQL();
		test.testSimpleAccess();
		test.testComplexType();
		test.testSimpleAccessVector();
		test.testComplexTypeVector();
		test.testInsertVector();
		test.testInsertEmptyVector();
		test.testInsertSingleBulk();
		test.testInsertSingleBulkVec();
		test.testLimit();
		test.testLimitOnce();
		test.testLimitPrepare();
		test.testLimitZero();
		test.testPrepare();
		test.testSetSimple();
		test.testSetComplex();
		test.testSetComplexUnique();
		test.testMultiSetSimple();
		test.testMultiSetComplex();
		test.testMapComplex();
		test.testMapComplexUnique();
		test.testMultiMapComplex();
		test.testSelectIntoSingle();
		test.testSelectIntoSingleStep();
		test.testSelectIntoSingleFail();
		test.testLowerLimitOk();
		test.testLowerLimitFail();
		test.testCombinedLimits();
		test.testCombinedIllegalLimits();
		test.testRange();
		test.testIllegalRange();
		test.testSingleSelect();
		test.testEmptyDB();
		test.testDateTime();
		test.testBLOB();
		test.testBLOBStmt();
		test.testUnsignedInts();
		test.testFloat();
		test.testDouble();
		test.testTuple();
		test.testTupleVector();
		test.testInternalExtraction();
		test.testNull();
		test.testNullableInt();
		test.testNullableString();
		test.testTupleWithNullable();
		test.testSessionTransaction();
